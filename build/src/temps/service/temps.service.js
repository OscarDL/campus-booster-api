...
const { Temps } = models_config_1.models;
/**
...
function findAll(options, scope = 'defaultScope') {
    return Temps.scope(scope).findAll(options);
}
...
function findOne(options, scope = 'defaultScope') {
    return Temps.scope(scope).findOne(options);
}
...
function findById(id, options, scope = 'defaultScope') {
    return Temps.scope(scope).findByPk(id, options);
}
...
function create(data, scope = 'defaultScope') {
    return Temps.scope(scope).create(data);
}
