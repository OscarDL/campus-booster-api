...
const TopicScope = __importStar(require("./topic.scope"));
...
let Topic = class Topic extends S.Model {
};
__decorate([
    S.PrimaryKey,
    S.Unique,
...
], Topic.prototype, "hidden", void 0);
__decorate([
    S.BelongsToMany(() => user_model_1.default, () => topic_user_model_1.default),
    __metadata("design:type", Array)
], Topic.prototype, "users", void 0);
Topic = __decorate([
    S.Scopes(TopicScope.default),
    S.Table({
        timestamps: true,
        underscored: false,
        tableName: 'topics',
