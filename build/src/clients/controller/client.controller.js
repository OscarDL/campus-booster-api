...
function getById(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return res.status(200).json(yield ClientService.findById(req.query.id));
        }
        catch (err) {
...
function getAll(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return res.status(200).json(yield ClientService.findAll({
                limit: (_a = req.query) === null || _a === void 0 ? void 0 : _a.limit,
                offset: (_b = req.query) === null || _b === void 0 ? void 0 : _b.offset
            }));
        }
        catch (err) {
            return yield (0, express_1.ExpressErrorHandler)(err)(req, res, next);
...
function create(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return res.status(201).json(yield ClientService.create({
                ...
                code: (_e = req.body) === null || _e === void 0 ? void 0 : _e.code
            }));
        }
        catch (err) {
            return yield (0, express_1.ExpressErrorHandler)(err)(req, res, next);
...
function update(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return res.status(203).json(yield ClientService.update((_a = req.query) === null || _a === void 0 ? void 0 : _a.id, req.body));
        }
        catch (err) {
            return yield (0, express_1.ExpressErrorHandler)(err)(req, res, next);
        }
...
function remove(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return res.status(204).json(yield ClientService.remove({
                where: {
