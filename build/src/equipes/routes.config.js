...
const EquipeController = __importStar(require("./controller/equipe.controller"));
const EquipeMiddleware = __importStar(require("./middleware/equipe.middleware"));
...
exports.default = (app) => {
    ...
    app.get('/equipe', [
        ...
        EquipeMiddleware.equipeExistAsQuery("id"),
